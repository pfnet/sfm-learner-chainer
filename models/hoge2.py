...
class SpatialTransformerSampler(function.Function):
    ...
    def _forward(self, inputs):
        ...
        # x = xp.pad(x, ((0, 0), (0, 0), (1, 1), (1, 1)), mode='constant')
        ...
        u_clipped = u.clip(0, W - 1.01)
        v_clipped = v.clip(0, H - 1.01)
    ...
    def _backward(self, inputs, grad_outputs):
        ...
        # --- gu, gv
        batch_index = xp.repeat(xp.arange(B), out_H * out_W)
        x_indexed_1 = x_pad[batch_index, :, v0, u0]
        x_indexed_2 = x_pad[batch_index, :, v0, u1]
        x_indexed_3 = x_pad[batch_index, :, v1, u0]
        x_indexed_4 = x_pad[batch_index, :, v1, u1]
...
def spatial_transformer_sampler2(x, grid, **kwargs):
